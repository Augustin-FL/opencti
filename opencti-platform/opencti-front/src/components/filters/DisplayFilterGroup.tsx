      ...
      return <>
        {
          i !== 0 && <Box
            sx={{
              textTransform: 'uppercase', fontWeight: 'bold', display: 'inline-block', borderRadius: '24px', padding: '8px 16px',
    ...
    return filters.map(({key, operator, values, mode}, i) => <Box sx={{
      ...
      <Box
        sx={{
          ...
          alignItems: 'center',
          gap: '16px',
          borderRadius: '24px', padding: '0 16px',
          backgroundColor: 'rgba(255, 255, 255, 0.16)', width: 'fit-content'
        }}>
        <span>{t(key)}</span>
        <Box
          sx={{
            textTransform: 'uppercase', fontFamily: 'Consolas, monaco, monospace',
            backgroundColor: 'rgb(74 117 162)', fontWeight: 'bold', display: 'inline-block', margin: '0 8px', padding: '8px'
          }}> {operator}</Box>
          ...
          <>
            <span> {t(value)} </span>
            {
              ...
              <Box
                sx={{
                  textTransform: 'uppercase', fontFamily: 'Consolas, monaco, monospace',
                  backgroundColor: 'rgba(255, 255, 255, .1)', fontWeight: 'bold', display: 'inline-block', margin: '0 8px', padding: '8px'
                }}>{t(mode)}</Box>
            }
          </>
        )}</Box>
    ...
    <>
      ...
      >
        <DialogTitle id="filter-groups-dialog-title">
          This filter contains imbricated filter groups, that are not fully supported yet in the platform display and
