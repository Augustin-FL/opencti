const i18n = {
  messages: {
    'es-es': {
      ...
      'Do not forget to update your': 'No olvides actualizar tu',
      ...
      Validity: 'Validez',
      'Representations for entity': 'Representaciones para entidad',
      ...
      'Last run': 'Última ejecución',
      Values: 'Valores',
      'Turn to Report or Case': 'Convertirse en Informe o Caso',
      entity: 'entidad',
      entities: 'entidades',
      Relation: 'Relación',
      progress: 'En curso',
      ...
      'Turn on edition mode': 'Activar el modo de edición',
      'Turn off edition mode': 'Desactivar el modo de edición',
      ...
      'entity_Stix-Meta-Objects': 'Metaentidades',
      ...
      Sample: 'ejemplo',
      'relationship_body-multipart': 'cuerpo multiparte',
      'relationship_body-raw': 'cuerpo en bruto',
      relationship_child: 'hijo',
      'relationship_creator-user': 'creador',
      relationship_detects: 'detecta',
      'relationship_dst-payload': 'carga de destino',
      'relationship_encapsulated-by': 'encapsulado por',
      relationship_encapsulates: 'encapsula',
      'relationship_host-vm': 'máquina virtual anfitriona',
      'relationship_installed-software': 'software instalado',
      'relationship_opened-connection': 'conexión abierta',
      'relationship_operating-system': 'sistema operativo',
      relationship_parent: 'padre',
      'relationship_parent-directory': 'directorio padre',
      'relationship_raw-email': 'correo electrónico en bruto',
      'relationship_src-payload': 'carga de origen',
      'relationship_reported-in': 'reportado en',
      'relationship_employed-by': 'empleado por',
      'relationship_resides-in': 'reside en',
      'relationship_citizen-of': 'ciudadano/a de',
      'relationship_national-of': 'nacional de',
      ...
      filter_creator_id: 'Creador técnico',
      filter_objectMarking: 'Clasificación',
      filter_objects: 'Contiene',
      ...
      filter_connectedToId: 'Entidad relacionada',
      filter_killChainPhase: 'Fase de la «kill chain»',
      filter_killChainPhases: 'Fases de la «kill chain»',
      filter_malware_types: 'Tipos de malware',
      filter_targets: 'Entidad de destino',
      filter_objectAssignee: 'Referente',
      filter_objectParticipant: 'Participante',
      ...
      X_opencti_reliability: 'Fiabilidad',
      ...
      FILE_INDEX_MANAGER: 'Gestor de índice de archivos',
      ...
      'Known observed eye color(s) for the Identity.':
        'Color(es) de ojos observado(s) conocido(s) para la Identidad.',
      ...
      'Parent organizations': 'Organizaciones matrices',
    ...
    'fr-fr': {
      ...
      Validity: 'Validité',
      'Representations for entity': 'Représentations pour une entité',
      ...
      'Base attribute': 'Attribut de base',
      ...
      'Last run': 'Dernière exécution',
      Values: 'Valeurs',
      'Turn to Report or Case': 'Transformer en Rapport ou Case',
      entity: 'entité',
      entities: 'entités',
      Relation: 'Relation',
      progress: 'En cours',
      ...
      Write: 'Ecrire',
      Preview: 'Aperçu',
      'Turn on edition mode': 'Activer le mode édition',
      'Turn off edition mode': 'Désactiver le mode édition',
      ...
      'entity_Stix-Meta-Objects': 'Meta entités',
      ...
      Sample: 'Exemple',
      'relationship_body-multipart': 'corps multipart',
      'relationship_body-raw': 'corps brut',
      relationship_child: 'enfant',
      'relationship_creator-user': 'créateur',
      relationship_detects: 'détecte',
      'relationship_dst-payload': 'charge utile de destination',
      'relationship_encapsulated-by': 'encapsulé par',
      relationship_encapsulates: 'encapsule',
      ...
      'relationship_src-payload': 'charge utile source',
      'relationship_reported-in': 'rapporté dans',
      'relationship_employed-by': 'employé par',
      'relationship_resides-in': 'réside dans',
      'relationship_citizen-of': 'citoyen de',
      'relationship_national-of': 'ressortissant de',
      confidence_0: 'Aucun',
      ...
      filter_creator_id: 'Créateur technique',
      filter_objectMarking: 'Marquage',
      filter_objects: 'Contient',
      ...
      filter_connectedToId: 'Entité liée',
      filter_killChainPhase: 'Phase de kill chain',
      filter_killChainPhases: 'Phases de kill chain',
      filter_malware_types: 'Type de code malveillant',
      filter_targets: 'Entité cible',
      filter_objectAssignee: 'Référent',
      filter_objectParticipant: 'Participant',
      ...
      'Context_data.search': 'Mot-clé de recherche',
      Indicator_types: 'Indicator types',
      Pattern_type: 'Pattern type',
      Valid_from: 'Valid from',
      Valid_until: 'Valid until',
      ...
      FILE_INDEX_MANAGER: "Manager d'indexation des fichiers",
    ...
    'ja-jp': {
      ...
      'Search the platform': 'プラットフォーム内で検索する',
      Active: 'アクティブ',
      Inactive: '非活性',
      'Last update': '最終更新',
      ...
      'Text files': 'テキストファイル',
      'HTML files': 'HTMLファイル',
      'Uploaded PDF files': 'アップロードされた PDF ファイル',
      ...
      Analytics: 'トラッキングシステム',
      'Do not forget to update your': '忘れずにアップデートしてください',
      ...
      Semicolon: 'セミコロン',
      Validity: '有効性',
      'Representations for entity': 'エンティティの表現',
      ...
      'Last run': '最終実行日時',
      Values: '値',
      'Turn to Report or Case': '「レポートまたはケースに変える」',
      entity: 'エンティティ',
      entities: 'エンティティ',
      Relation: 'リレーション',
      progress: '進捗',
      ...
      Write: '編集',
      Preview: 'プレビュー',
      'Turn on edition mode': '編集モードをオンにする',
      'Turn off edition mode': '編集モードをオフにする',
      'Graph type': 'グラフタイプ',
      ...
      'entity_Stix-Meta-Objects': 'メタエンティティ',
      ...
      'relationship_citizen-of': 'の市民',
      'relationship_national-of': '～の国民',
      'relationship_host-vm': 'ホストVM',
      'relationship_installed-software': 'インストールされたソフトウェア',
      confidence_0: '極めて低い',
      confidence_15: '低',
      confidence_75: '高',
      confidence_85: '極めて高い',
      ...
      filter_creator_id: 'テクニカルクリエーター',
      filter_objectMarking: 'データマーキング',
      filter_objects: '含む',
      ...
      filter_connectedToId: '関連エンティティ',
      filter_killChainPhase: 'キルチェーンフェーズ',
      filter_killChainPhases: 'キルチェーンフェーズ',
      filter_malware_types: 'マルウェア種別',
      filter_targets: 'ターゲットのエンティティ',
      filter_objectAssignee: '譲受人',
      filter_objectParticipant: '参加者',
      ...
      update: 'Modification events',
      delete: 'Deletion events',
      'Demographic Information': '人口統計情報',
      Demographics: '人口統計',
      ...
      'Add a weight': '重りを追加する',
      'Biographic Information': '略歴',
      Biographics: '略歴',
      'Eye Color': '目の色',
      'Known observed eye color(s) for the Identity.':
        'アイデンティティの既知の観察された目の色。',
      'Hair Color': '髪の色',
      'Known observed hair color(s) for the Identity.':
    ...
    'zh-cn': {
      ...
      Analytics: '追蹤系統',
      'Do not forget to update your': '不要忘記更新您的',
      'consent message': '同意訊息',
      'if needed': '如果需要的話',
      // Ingestion Menu
      Ingestion: '食入',
      ...
      Semicolon: '分号',
      Validity: '有效性',
      'Representations for entity': '实体表达',
      ...
      'Last run': '上次运行',
      Values: '值',
      'Turn to Report or Case': '变成报告或案例',
      entity: '实体',
      entities: '实体',
      Relation: '关系',
      progress: '进展',
      ...
      'Extend this search to indexed files': '将此搜索扩展到索引文件',
      ...
      Write: '写入',
      Preview: '预览',
      'Turn on edition mode': '打开编辑模式',
      'Turn off edition mode': '关闭编辑模式',
      'Graph type': '图表类型',
      'Table (top 10)': '表(前10个)',
      ...
      Sample: '例子',
      'relationship_body-multipart': '正文多部分',
      'relationship_body-raw': '正文原始',
      relationship_child: '子级',
      'relationship_creator-user': '创建者',
      relationship_detects: '检测',
      'relationship_dst-payload': '目标负载',
      'relationship_encapsulated-by': '封装于',
      relationship_encapsulates: '封装',
      'relationship_host-vm': '主机虚拟机',
      'relationship_installed-software': '安装的软件',
      'relationship_opened-connection': '打开的连接',
      'relationship_operating-system': '操作系统',
      relationship_parent: '父级',
      'relationship_parent-directory': '上级目录',
      'relationship_raw-email': '原始电子邮件',
      'relationship_src-payload': '源负载',
      'relationship_reported-in': '報告於',
      'relationship_employed-by': '雇佣',
      'relationship_resides-in': '驻留在',
      'relationship_citizen-of': '的公民',
      'relationship_national-of': '的国家',
      confidence_0: '无',
      confidence_15: '低',
      confidence_50: '中',
      confidence_75: '好',
      ...
      filter_creator_id: '技術創造者',
      filter_objectMarking: '标记',
      filter_objects: '包含',
      ...
      filter_connectedToId: '相关实体',
      filter_killChainPhase: '杀伤链阶段',
      filter_killChainPhases: '杀伤链阶段',
      filter_malware_types: '恶意软件类型',
      filter_targets: '目标实体',
      filter_objectAssignee: '受让人',
      filter_objectParticipant: '参与者',
      filter_priority: '优先',
      filter_severity: '严重性',
      filter_is_read: '是读？',
      ...
      'Please contact an administrator': '请联系管理员',
    ...
    'en-us': {
      ...
      filter_creator_id: 'Technical creator',
      filter_objectMarking: 'Marking definition',
      filter_objects: 'Contains',
      ...
      filter_connectedToId: 'Related entity',
      filter_killChainPhase: 'Kill Chain phase',
      filter_killChainPhases: 'Kill Chain phases',
      filter_malware_types: 'Malware types',
      filter_targets: 'Target entity',
      filter_objectAssignee: 'Assignee',
      filter_objectParticipant: 'Participant',
